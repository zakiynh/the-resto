                ...
                <div className="mt-10">
                    <form action="#">
                        <div className="flex flex-col mb-5">
                            <label htmlFor="username" className="mb-1 text-xs items- tracking-wide text-gray-600">
                                Name:
                            </label>
                        ...
                        <div className="flex flex-col mb-6">
                            <label htmlFor="phoneNumber" className="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">
                                Phone Number:
                            </label>
                            <div className="relative">
                                <div
            ...
            <div className="flex justify-center items-center mt-6">
                ...
                >
                    <span className="ml-2">
                        ...
                        <a href="#" className="text-xs ml-2 text-amber-500 font-semibold">
                            Sign in now
                        </a>
                    </span>
                </a>
